# /vlm_gym/environments/tools/sympy_geometry.py
"""
SymPy几何计算工具
用于处理各种几何计算任务
"""
...
from sympy import Point, Segment, Circle, pi, sqrt, sin, cos, tan, asin, acos, atan2
from sympy.geometry import Triangle, Line, angle, Polygon, Ray, intersection
